...
const ORPHANS = [
  { initials: 'BT',  name: 'Budget Torres',       role: 'Budget Management',          influence: '8.1', sentiment: '5.2', borderColor: '#F59E0B' },
  { initials: 'CA',  name: 'Council Abadi',        role: 'Infrastructure Committee',   influence: '7.4', sentiment: '4.8', borderColor: '#F59E0B' },
  { initials: 'PD',  name: 'Procurement Davis',    role: 'Vendor Compliance',          influence: '6.8', sentiment: '3.9', borderColor: '#6B7280', shape: 'rect' },
  { initials: 'LPS', name: 'Legacy Permits Sys.',  role: 'Permitting Platform',        influence: '5.2', sentiment: '2.1', borderColor: '#6B7280', shape: 'rect' },
]
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ width: 420, background: '#111827', borderLeft: '1px solid #2A3650' }}>
      ...
      <div className="flex items-center gap-2.5 px-5 py-4" style={{ borderBottom: '1px solid #2A3650' }}>
        ...
        <div className="flex items-center gap-1 px-2 py-0.5 rounded" style={{ background: '#3B82F620' }}>
          <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#3B82F6' }} />
          <span className="font-mono font-bold text-xs tracking-widest" style={{ color: '#3B82F6' }}>LIVE</span>
        </div>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-4 gap-2 px-5 py-3" style={{ borderBottom: '1px solid #2A3650' }}>
        {STATS.map(s => (
      ...
      <div className="flex flex-col gap-2.5 px-5 py-3.5" style={{ borderBottom: '1px solid #2A3650' }}>
        <div className="flex items-center gap-2">
          ...
          <div className="px-1.5 py-0.5 rounded" style={{ background: '#1F2A40' }}>
            <span className="font-mono text-xs font-medium" style={{ color: '#F59E0B' }}>High influence · 0 interactions</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          {ORPHANS.map((o, i) => (
            <div key={i} className="flex items-center gap-2.5 px-3 py-2.5 rounded-md" style={{ background: '#1A2035', border: '1px solid #1E2A3E' }}>
              <div
              ...
              <div className="flex flex-col gap-0.5 flex-1 min-w-0">
                <span className="font-mono font-semibold text-xs" style={{ color: '#E8ECF4' }}>{o.name}</span>
              ...
              <div className="flex flex-col items-end gap-0.5">
                ...
                <span className="font-mono text-xs" style={{ color: '#EF4444' }}>{o.sentiment}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        >
          <span className="font-mono font-bold text-xs tracking-widest" style={{ color: '#E8ECF4', letterSpacing: '0.1em' }}>
            CITY NAVIGATION MAP — PORTLAND DOT
          </span>
          <span className="font-mono text-xs" style={{ color: '#5A6580' }}>Pathfinder View · Sentiment Analysis · Live</span>
        </div>
